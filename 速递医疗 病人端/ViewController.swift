...
class ViewController:UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        imgLock1.image = #imageLiteral(resourceName: "icon_label_yh_03")
        
        //密码图标
        let imgLock2 =  UIImageView(frame:CGRect(x: 11, y: 11, width: 22, height: 22))
        imgLock2.image = #imageLiteral(resourceName: "icon_label_yh")
        ...
        self.confirmButton.backgroundColor = UIColor(red: 1, green: 1, blue: 1,
                                                     alpha: 0.5)
